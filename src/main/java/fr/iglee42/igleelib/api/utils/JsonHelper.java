        ...
        try {
            ...
            for (RecordComponent component : recordClass.getRecordComponents()) {
                if (Integer.class.equals(component.getType()) || int.class.equals(component.getType())) {
                    ...
                    if (component.isAnnotationPresent(DefaultParameter.class)) {
                        args.add(getItemOrDefault(json, component.getName(), ForgeRegistries.ITEMS.getValue(new ResourceLocation(component.getAnnotation(DefaultParameter.class).itemValue()))));
                    } else {
                    ...
                    if (component.isAnnotationPresent(DefaultParameter.class)) {
                        args.add(getBlockOrDefault(json, component.getName(),ForgeRegistries.BLOCKS.getValue(new ResourceLocation(component.getAnnotation(DefaultParameter.class).blockValue()))));
                    } else {
                    ...
                    if (component.isAnnotationPresent(DefaultParameter.class)) {
                        args.add(getEntityTypeOrDefault(json, component.getName(),ForgeRegistries.ENTITY_TYPES.getValue(new ResourceLocation(component.getAnnotation(DefaultParameter.class).entityTypeValue()))));
                    } else {
                        args.add(getEntityType(json,component.getName()));
                    }
                    classes.add(component.getType());
                } else if (Enchantment.class.equals(component.getType())) {
                    if (component.isAnnotationPresent(DefaultParameter.class)) {
                        args.add(getEnchantmentOrDefault(json, component.getName(),ForgeRegistries.ENCHANTMENTS.getValue(new ResourceLocation(component.getAnnotation(DefaultParameter.class).enchantmentValue()))));
                    } else {
                        args.add(getEnchantment(json,component.getName()));
                    }
                    classes.add(component.getType());
