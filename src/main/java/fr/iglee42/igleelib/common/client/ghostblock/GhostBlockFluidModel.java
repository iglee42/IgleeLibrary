...
public final class GhostBlockFluidModel implements IModelGeometry<GhostBlockFluidModel>
{
    public static final GhostBlockFluidModel WATER = new GhostBlockFluidModel(Fluids.WATER);
    public static final GhostBlockFluidModel LAVA = new GhostBlockFluidModel(Fluids.LAVA);

    private final Fluid fluid;

    public GhostBlockFluidModel(Fluid fluid)
    {
        this.fluid = fluid;
    }
