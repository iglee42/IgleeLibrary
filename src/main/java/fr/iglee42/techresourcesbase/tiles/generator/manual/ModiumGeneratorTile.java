...
public class ModiumGeneratorTile  extends TileEntity implements ITickableTileEntity {

    private GessenceType gessence;
    private int delay;
    private int tick;
    public ModiumGeneratorTile() {
        super(ModTileEntity.MODIUM_GENERATOR_TILE.get());
    }
