...
import fr.iglee42.techresourcesbase.tiles.generator.manual.*;
...
public class ModTileEntity {
    ...
    public static final RegistryObject<TileEntityType<?>> LAVIUM_GENERATOR_TILE =TILE_ENTITIES.register("lavium_generator_tile",() -> TileEntityType.Builder.of(LaviumGeneratorTile::new,ModBlock.LAVIUM_GENERATOR.get()).build(null));
}
